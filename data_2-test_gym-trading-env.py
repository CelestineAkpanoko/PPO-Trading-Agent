...
def test_model(env, model, n_episodes=10, render_dir="data-2_render_logs"):
    """
...
df = pd.read_pickle("./data/binance-BTCUSDT-4h.pkl")
...
# Test the model
test_model(env, model, n_episodes=10, render_dir="data-2_render_logs")
